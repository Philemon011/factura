...
export default function InvoicesPage() {
  ...
  const handleConfirmDelete = () => {
    if (targetId) deleteInvoice(targetId)
    setTargetId(null)
  }
            ...
            <table className="w-full min-w-[640px]">
              <thead>
                <tr className="border-b border-zinc-100 dark:border-zinc-800">
                  <th className="px-4 py-3 text-left text-xs font-medium text-zinc-400 sm:px-6">
                    Numéro
                  </th>
                  <th className="px-4 py-3 text-left text-xs font-medium text-zinc-400 sm:px-6">
                    Client
                  </th>
                  <th className="hidden px-4 py-3 text-left text-xs font-medium text-zinc-400 sm:table-cell sm:px-6">
                    Date émission
                  </th>
                  <th className="hidden px-4 py-3 text-left text-xs font-medium text-zinc-400 sm:table-cell sm:px-6">
                    Échéance
              ...
              <tbody>
                {filtered.map((invoice, i) => (
                  ...
                  >
                    ...
                    <td className="hidden px-4 py-3.5 text-sm text-zinc-500 dark:text-zinc-500 sm:table-cell sm:px-6 sm:py-4">
